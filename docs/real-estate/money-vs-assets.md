...
```mermaid
mindmap
  root((Tiền vs Tài Sản))
    Concept["Bản chất"]
      money["Tiền = Giấy nợ (In được vô hạn)"]
      asset["Tài sản = Hàng thật (Hữu hạn)"]
    Mechanics["Cơ chế vận hành"]
      inflation["In tiền -> Lạm phát (Mất sức mua)"]
      value["Tài sản tăng giá bù lạm phát"]
    Action["Hành động"]
      switch["Chuyển Tiền -> Tài sản"]
      hold["Nắm giữ dài hạn (10-20 năm)"]
      emergency["Chỉ giữ tiền dự phòng (3-6 tháng)"]
    Risk["Rủi ro & Phòng vệ"]
      liquidity["Thanh khoản thấp -> Cần quỹ dự phòng"]
      knowledge["Mua nhầm rác -> Cần kiến thức"]
```

<br/>

___
<center>Made by Anh Tu - Share to be share</center>
