...
Điểm kỳ diệu của Next.js (App Router) là **bạn không cần phải khai báo thủ công** trang này là Static hay Dynamic bằng các hàm đặc biệt như `getStaticProps` hay `getServerSideProps` (của Next.js đời cũ) nữa. 

Next.js sẽ tự động phân tích code của bạn.
