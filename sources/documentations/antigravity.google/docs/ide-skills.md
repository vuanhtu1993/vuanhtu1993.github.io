...
source_url: "https://antigravity.google/docs/ide-skills"
crawled_at: "2026-06-12T03:43:51.962Z"
---
...
Every skill needs a `SKILL.md` file with YAML frontmatter at the top:
            ...
            `--- name: my-skill description: Helps with a specific task. Use when you need to do X or Y. ---  # My Skill  Detailed instructions for the agent go here.  ## When to use this skill  - Use this when... - This is helpful for...  ## How to use it  Step-by-step guidance, conventions, and patterns the agent should follow.`
...
While `SKILL.md` is the only required file, you can include additional resources:
            ...
            `.agents/skills/my-skill/ ├─── SKILL.md       # Main instructions (required) ├─── scripts/       # Helper scripts (optional) ├─── examples/      # Reference implementations (optional) └─── resources/     # Templates and other assets (optional)`
