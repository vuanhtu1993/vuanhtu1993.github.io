...
source_url: "https://antigravity.google/docs/ide-mcp"
crawled_at: "2026-06-12T03:43:49.007Z"
---
...
![Click Authenticate](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781235828/aha-mind/docs-crawler/antigravity.google/mcp-oauth-authenticate_nqupni.png)

1.  Complete authentication in your browser and copy the authorization code.

![Copy authorization code](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781235828/aha-mind/docs-crawler/antigravity.google/mcp-oauth-copy-code_morlpy.png)

1.  Paste the code back into the settings panel and click **Submit**.

![Paste auth code](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781235828/aha-mind/docs-crawler/antigravity.google/mcp-oauth-paste-code_jleygd.png)

Once authenticated, the server will reconnect automatically.

![Authenticated server](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781235828/aha-mind/docs-crawler/antigravity.google/mcp-oauth-authenticated_cnxrla.png)
