...
source_url: "https://nextjs.org/docs/pages/guides/multi-zones"
crawled_at: "2026-06-25T07:23:50.780Z"
---
...
![Three zones: A, B, C. Showing a hard navigation between routes from different zones, and soft navigations between routes within the same zone.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782372235/aha-mind/docs-crawler/nextjs.org/image_vrqjti.png)![Three zones: A, B, C. Showing a hard navigation between routes from different zones, and soft navigations between routes within the same zone.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782372235/aha-mind/docs-crawler/nextjs.org/image_esm9dp.png)
