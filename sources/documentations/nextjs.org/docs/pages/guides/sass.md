---
title: "Guides: Sass"
source_url: "https://nextjs.org/docs/pages/guides/sass"
crawled_at: "2026-06-25T07:24:34.824Z"
---

This page is also available as Markdown at [/docs/pages/guides/sass.md](https://nextjs.org/docs/pages/guides/sass.md). For an index of Next.js Pages Router documentation, see [/docs/pages/llms.txt](https://nextjs.org/docs/pages/llms.txt).
