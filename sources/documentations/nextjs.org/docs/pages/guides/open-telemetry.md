...
source_url: "https://nextjs.org/docs/pages/guides/open-telemetry"
crawled_at: "2026-06-25T07:23:57.150Z"
---
...
> -   If you use the [`pageExtensions` config option](https://nextjs.org/docs/pages/api-reference/config/next-config-js/pageExtensions) to add a suffix, you will also need to update the `instrumentation` filename to match.
