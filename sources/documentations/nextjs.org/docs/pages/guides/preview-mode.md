---
title: "Guides: Preview Mode"
source_url: "https://nextjs.org/docs/pages/guides/preview-mode"
crawled_at: "2026-06-25T07:24:17.028Z"
---
...
In the [Pages documentation](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts) and the [Data Fetching documentation](https://nextjs.org/docs/pages/building-your-application/data-fetching), we talked about how to prerender a page at build time (**Static Generation**) using `getStaticProps` and `getStaticPaths`.
