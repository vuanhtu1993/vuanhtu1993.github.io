---
title: "Functions: unstable_rethrow"
source_url: "https://nextjs.org/docs/app/api-reference/functions/unstable_rethrow"
crawled_at: "2026-06-25T07:11:01.961Z"
---

This page is also available as Markdown at [/docs/app/api-reference/functions/unstable\_rethrow.md](https://nextjs.org/docs/app/api-reference/functions/unstable_rethrow.md). For an index of Next.js documentation, see [/docs/llms.txt](https://nextjs.org/docs/llms.txt).
