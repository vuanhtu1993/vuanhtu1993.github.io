...
crawled_at: "2026-06-25T07:19:14.521Z"
---
...
### `next typegen` options[](#next-typegen-options)
...
### `next upgrade` options[](#next-upgrade-options)
...
### Debugging prerender errors[](#debugging-prerender-errors)
...
### Building specific routes[](#building-specific-routes)
