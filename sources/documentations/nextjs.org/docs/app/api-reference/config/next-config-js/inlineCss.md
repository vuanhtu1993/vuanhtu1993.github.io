...
crawled_at: "2026-06-25T07:15:05.983Z"
---

This page is also available as Markdown at [/docs/app/api-reference/config/next-config-js/inlineCss.md](https://nextjs.org/docs/app/api-reference/config/next-config-js/inlineCss.md). For an index of Next.js documentation, see [/docs/llms.txt](https://nextjs.org/docs/llms.txt).
