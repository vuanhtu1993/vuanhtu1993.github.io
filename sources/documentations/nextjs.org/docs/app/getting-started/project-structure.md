...
crawled_at: "2026-06-25T06:55:40.457Z"
---
...
![Route segments to path segments](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_llpoqt.png)![Route segments to path segments](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_uxek3h.png)
...
![Component Hierarchy for File Conventions](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_tnfbtv.png)![Component Hierarchy for File Conventions](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_llppww.png)

The components are rendered recursively in nested routes, meaning the components of a route segment will be nested **inside** the components of its parent segment.

![Nested File Conventions Component Hierarchy](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_beeivu.png)![Nested File Conventions Component Hierarchy](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370545/aha-mind/docs-crawler/nextjs.org/image_vp4asg.png)
...
![A diagram showing how a route is not publicly accessible until a page.js or route.js file is added to a route segment.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_ya2a3o.png)![A diagram showing how a route is not publicly accessible until a page.js or route.js file is added to a route segment.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_xuztdj.png)

And, even when a route is made publicly accessible, only the **content returned** by `page.js` or `route.js` is sent to the client.

![A diagram showing how page.js and route.js files make routes publicly accessible.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_ffmqre.png)![A diagram showing how page.js and route.js files make routes publicly accessible.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370545/aha-mind/docs-crawler/nextjs.org/image_z2u6bj.png)

This means that **project files** can be **safely colocated** inside route segments in the `app` directory without accidentally being routable.

![A diagram showing colocated project files are not routable even when a segment contains a page.js or route.js file.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_c9y39v.png)![A diagram showing colocated project files are not routable even when a segment contains a page.js or route.js file.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_safdzh.png)
...
![An example folder structure using private folders](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_myf9vj.png)![An example folder structure using private folders](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_dvn3v1.png)
...
![An example folder structure using route groups](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_apbwrq.png)![An example folder structure using route groups](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370545/aha-mind/docs-crawler/nextjs.org/image_hvmfsh.png)
...
![An example folder structure with the \`src\` folder](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_ulsmrd.png)![An example folder structure with the \`src\` folder](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_lamgtx.png)
...
![An example folder structure with project files outside of app](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_zv2ayo.png)![An example folder structure with project files outside of app](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_mdlcxt.png)
...
![An example folder structure with project files inside app](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_hyjlym.png)![An example folder structure with project files inside app](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_s30miz.png)

### Split project files by feature or route[](#split-project-files-by-feature-or-route)

This strategy stores globally shared application code in the root `app` directory and **splits** more specific application code into the route segments that use them.

![An example folder structure with project files split by feature or route](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_pkq4ub.png)![An example folder structure with project files split by feature or route](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_topcsz.png)
...
![Organizing Routes with Route Groups](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_ck2sov.png)![Organizing Routes with Route Groups](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370545/aha-mind/docs-crawler/nextjs.org/image_yzk2pe.png)

Even though routes inside `(marketing)` and `(shop)` share the same URL hierarchy, you can create a different layout for each group by adding a `layout.js` file inside their folders.

![Route Groups with Multiple Layouts](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370545/aha-mind/docs-crawler/nextjs.org/image_wivovf.png)![Route Groups with Multiple Layouts](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_i1sanq.png)
...
![Route Groups with Opt-in Layouts](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_obzjod.png)![Route Groups with Opt-in Layouts](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370543/aha-mind/docs-crawler/nextjs.org/image_uz8wis.png)
...
![Folder structure showing a loading.tsx and a page.tsx inside the route group](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_rogwbr.png)![Folder structure showing a loading.tsx and a page.tsx inside the route group](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_o1ge7a.png)
...
![Route Groups with Multiple Root Layouts](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_kphmbp.png)![Route Groups with Multiple Root Layouts](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782370544/aha-mind/docs-crawler/nextjs.org/image_nrwcdz.png)
