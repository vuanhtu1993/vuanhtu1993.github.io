---
title: "Guides: CDN Caching"
source_url: "https://nextjs.org/docs/app/guides/cdn-caching"
crawled_at: "2026-06-25T06:58:02.548Z"
---
...
You can use [`assetPrefix`](https://nextjs.org/docs/app/api-reference/config/next-config-js/assetPrefix) to serve static assets from a different domain or CDN origin.
...
## Where CDN Caching Is Challenging[](#where-cdn-caching-is-challenging)
...
## Handling Headers at the CDN[](#handling-headers-at-the-cdn)

### What you can safely ignore[](#what-you-can-safely-ignore)
...
## Direction: Pathname-Based Cache Keying[](#direction-pathname-based-cache-keying)
...
The approach extends the routing scheme that [`output: 'export'`](https://nextjs.org/docs/app/guides/static-exports) and segment prefetches already use today. File extensions in the pathname identify the response type:
...
### What changes for interception routes[](#what-changes-for-interception-routes)
...
For a full table showing the infrastructure primitives available on every major CDN (edge compute, key-value storage, blob storage, PPR resuming), see [Deploying to Platforms](https://nextjs.org/docs/app/guides/deploying-to-platforms#cdn-infrastructure-compatibility).
