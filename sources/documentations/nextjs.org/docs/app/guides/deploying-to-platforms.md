---
title: "Guides: Deploying to Platforms"
source_url: "https://nextjs.org/docs/app/guides/deploying-to-platforms"
crawled_at: "2026-06-25T06:58:40.090Z"
---
...
**Functional fidelity** means every Next.js feature works correctly. The [adapter test suite](https://nextjs.org/docs/app/api-reference/adapters/testing-adapters) is the contract: if a platform's adapter passes the tests, it supports Next.js. This is binary: it passes or it doesn't.
...
| ISR (on-demand) | No | Recommended | No | [Tag propagation](https://nextjs.org/docs/app/guides/how-revalidation-works) needs shared cache for multi-instance |
| Partial Prerendering | Required | Recommended | Optional | [See PPR Platform Guide](https://nextjs.org/docs/app/guides/ppr-platform-guide) |
...
| `after()` | No | No | No | Requires [graceful shutdown](https://nextjs.org/docs/app/guides/self-hosting#after) support |
...
2.  **Runs the compatibility test suite.** The platform provides a way to run the full [Next.js compatibility test suite](https://nextjs.org/docs/app/api-reference/adapters/testing-adapters) against their adapter. This gives visibility into which features work, which are in progress, and where gaps remain.
