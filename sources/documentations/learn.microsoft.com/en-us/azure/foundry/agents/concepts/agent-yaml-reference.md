---
title: "agent.yaml schema reference - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/agent-yaml-reference"
crawled_at: "2026-06-27T11:31:57.059Z"
---
...
Both files describe _what_ an agent is: its model, tools, protocols, environment, and resources. This is distinct from `azure.yaml`, which describes _how_ to provision and deploy Azure resources. For the `azure.yaml` reference, see [azure.yaml reference for hosted agents](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/azure-yaml-reference).
...
For the full protocol specification, see [Hosted agent runtime contract](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/hosted-agent-contract).
