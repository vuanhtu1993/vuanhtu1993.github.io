---
title: "Set up CI/CD for a hosted agent - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/quickstarts/set-up-cicd-hosted-agent?pivots=azd"
crawled_at: "2026-06-27T11:31:54.658Z"
---
...
| GitHub OIDC configuration | Configure a Microsoft Entra application or federated credential that allows your GitHub workflow to sign in to Azure with OIDC. For more information, see [Use the Azure login action with OpenID Connect](https://learn.microsoft.com/en-us/azure/developer/github/connect-from-azure#use-the-azure-login-action-with-openid-connect). |
...
4.  Update the workflow placeholders.
...
-   [Use OpenID Connect with Azure Login for GitHub Actions](https://learn.microsoft.com/en-us/azure/developer/github/connect-from-azure)
