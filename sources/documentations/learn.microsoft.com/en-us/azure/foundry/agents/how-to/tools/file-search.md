---
title: "File search tool for Microsoft Foundry agents - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/file-search?tabs=prompt-agents&pivots=python"
crawled_at: "2026-06-27T11:33:24.165Z"
---
...
You can customize file search behavior at runtime, such as specifying which vector store to use per request, by using [structured inputs](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/structured-inputs).

The following code sample shows how to create an agent with the file search tool enabled. You need to upload files and create a vector store before running this code. Select **Prompt Agents** to use the Azure AI Projects SDK to create a server-side prompt agent, or **Hosted Agents** to use the Agent Framework [`FoundryChatClient`](https://learn.microsoft.com/en-us/azure/foundry/agents/quickstarts/responses-api) to build an ephemeral, in-process agent.
...
-   Reference: [Agents REST API (preview)](https://learn.microsoft.com/en-us/azure/foundry/reference/foundry-project-rest-preview)
...
| --- | --- |
| Search existing Azure AI Search indexes | [Azure AI Search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/ai-search) |
| Search the public web for current information | [Web search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/web-search) |
...
For background concepts and lifecycle guidance (readiness, deletion behavior, and expiration policies), see [Vector stores for file search](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/vector-stores).
...
-   Features and availability vary by region. See [Azure AI Foundry region support](https://learn.microsoft.com/en-us/azure/foundry/reference/region-support).
...
-   [Azure AI Search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/ai-search) - Search existing Azure AI Search indexes from your agents
-   [Web search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/web-search) - Enable agents to search the public web
-   [Vector stores for file search](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/vector-stores) - Understand vector store lifecycle and expiration
-   [Structured inputs](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/structured-inputs) - Parameterize agent definitions at runtime
