---
title: "Curate intent-based toolbox in Foundry (preview) - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/toolbox?source=recommendations&pivots=python"
crawled_at: "2026-06-27T11:35:06.576Z"
---
...
[![Diagram showing multiple agents each wiring their own tools with different authentication models and duplicated credentials.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782560106/aha-mind/docs-crawler/learn.microsoft.com/toolbox-before_btbaq5.png)](https://learn.microsoft.com/en-us/azure/foundry/agents/media/tools/toolbox/toolbox-before.png#lightbox)
...
[![Diagram showing Toolboxes in Foundry architecture: Build and Consume pillars consumed by LangGraph, Microsoft Agent Framework, GitHub Copilot, Claude Code, and Microsoft Copilot Studio, governed by default.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782560106/aha-mind/docs-crawler/learn.microsoft.com/toolbox-architecture_jrdyop.png)](https://learn.microsoft.com/en-us/azure/foundry/agents/media/tools/toolbox/toolbox-architecture.png#lightbox)
...
| [MCP tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/model-context-protocol) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Web Search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/web-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Azure AI Search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/ai-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Code Interpreter tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/code-interpreter) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [File Search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/file-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [OpenAPI tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/openapi) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Agent-to-Agent (A2A) tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/agent-to-agent) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Fabric IQ tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/fabric-iq) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| Guardrail (RAI policy) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Skill references](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/skills) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Tool Search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/tool-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Work IQ tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/work-iq) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Browser Automation tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/browser-automation) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
...
-   **Azure Developer CLI**: [Install the Azure Developer CLI](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/install-azd) (`azd`, 1.25 or later) and the unified Foundry CLI extension bundle:
...
5.  To enable intent-based tool routing, select **Tool search**.
6.  To add Work IQ or Fabric IQ tools, select **\+ Add tool** and choose the corresponding tool type. Provide the required project connection when prompted. For end-to-end setup details, see [Use the Work IQ tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/work-iq) and [Use the Fabric IQ tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/fabric-iq).
7.  Select **Publish**.

Publishing a new toolbox creates its first version. That version becomes the default version automatically.

[![Screenshot of the Microsoft Foundry Toolkit for Visual Studio Code extension showing the Build a Custom Toolbox view with fields for the toolbox name, description, and tools, plus the Publish action.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782560106/aha-mind/docs-crawler/learn.microsoft.com/toolbox-vscode-create_vuo5go.png)](https://learn.microsoft.com/en-us/azure/foundry/agents/media/tools/toolbox/toolbox-vscode-create.png#lightbox)
...
3.  Author a toolbox YAML that references one or more existing connections by name. The YAML never embeds credentials:
    ...
    At least one of `connections`, `skills`, or `tools` must be non-empty. Skill references must point to skills that already exist in the same Foundry project; see [Use skills in Foundry](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/skills) to create them with `azd ai skill create`. For end-to-end Tool Search, Work IQ, and Fabric IQ setup details, see [Use tool search](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/tool-search), [Use the Work IQ tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/work-iq), and [Use the Fabric IQ tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/fabric-iq).
...
[![Screenshot of the Microsoft Foundry Toolkit for Visual Studio Code extension showing the Toolboxes view with the toolbox endpoint URL and the Scaffold code template action.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782560106/aha-mind/docs-crawler/learn.microsoft.com/toolbox-vscode-list_kypjd7.png)](https://learn.microsoft.com/en-us/azure/foundry/agents/media/tools/toolbox/toolbox-vscode-list.png#lightbox)
...
2.  Set the endpoint as an environment variable that your agent reads at startup:
...
3.  In your agent code, read `TOOLBOX_ENDPOINT` and connect to it with an MCP client. Use the Python or .NET integration patterns earlier in this section as a reference for the client setup, the `Foundry-Features: Toolboxes=V1Preview` header, and the Entra token (`https://ai.azure.com/.default` scope).
...
-   See the [management section](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/web-search#administrator-control-for-the-web-search-tool) for information about how Azure admins can manage access to use of web search.
...
The returned file `id` is the value you supply as `<FILE_ID>` in the tool configuration. Files are mounted in the sandbox at `/mnt/data/{file-id}-{original-filename}`. See [Code Interpreter](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/code-interpreter) for additional upload examples and language-specific samples.
...
Use the file name returned from Step 1 to download the file via the [File API download endpoint](https://learn.microsoft.com/en-us/rest/api/microsoft-foundry/azureopenai/files?view=rest-microsoft-foundry-v1&preserve-view=true).
...
The resulting vector store ID is the value you supply as `<VECTOR_STORE_ID>`. See [File Search](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/file-search) for full examples in each language.
...
For `server_url` patterns by Fabric item type, see [Find your Fabric IQ server details](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/fabric-iq#find-your-fabric-iq-server-details).
...
In Foundry Toolkit for Visual Studio Code, select **Tool search** on the **Build a Custom Toolbox** tab when you create or edit a toolbox. For more information, see [Enable tool search in a toolbox](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/tool-search#enable-tool-search).
...
Apply a named [guardrail policy](https://learn.microsoft.com/en-us/azure/foundry/guardrails/guardrails-overview) to a toolbox version to enforce responsible AI content filtering on tool inputs and outputs. The guardrail runs at the toolbox layer, independently of any model-level content filter.
...
Attach [skills](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/skills) to a toolbox version to make them available to agents through the toolbox MCP endpoint. Each skill reference specifies the skill name and an optional version. Omit `version` to use the skill's `default_version`; pin a `version` string to use an immutable snapshot.
...
When your Foundry project uses [network isolation (private link)](https://learn.microsoft.com/en-us/azure/foundry/how-to/configure-private-link), not all toolbox tool types are supported. The following table shows the support status for each tool type and how traffic flows in a network-isolated environment.

| Tool type | VNet support | Traffic flow |
| --- | --- | --- |
| [MCP](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/model-context-protocol) | ✅ Supported | Through your VNet subnet |
| [Azure AI Search](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/ai-search) | ✅ Supported | Through private endpoint |
| [Code Interpreter](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/code-interpreter) | ✅ Supported | Microsoft backbone network |
| [Web Search](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/web-search) | ✅ Supported | Public endpoint |
| [OpenAPI](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/openapi) | ✅ Supported | Depends on target API network configuration |
| [File Search](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/file-search) | ❌ Not supported | Not yet available |
| [Agent-to-Agent (A2A)](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/agent-to-agent) | ✅ Supported | Through private endpoint |
| [Fabric IQ](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/fabric-iq) | ❌ Not supported | Not yet available |
| [Work IQ](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/work-iq) | ❌ Not supported | Not yet available |
| [Browser Automation](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/browser-automation) | ❌ Not supported | Not yet available |

For full network isolation setup instructions, including VNet injection for the agent client, DNS configuration, and private endpoint requirements, see [Configure network isolation for Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/how-to/configure-private-link).
...
Before deploying a toolbox, verify that your target region supports the tool types you plan to use. For the full compatibility tables, see [Tool support by region and model](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice#tool-support-by-region-and-model).
