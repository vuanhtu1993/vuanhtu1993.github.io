---
title: "Use the Microsoft Fabric data agent with Foundry agents - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/fabric?tabs=prompt-agents&pivots=python"
crawled_at: "2026-06-27T11:34:39.959Z"
---
...
-   Assign developers and end users at least the `Foundry User` Azure RBAC role. For more information, see [Azure role-based access control in Foundry](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry).
...
-   Give developers and end users at least `READ` access to the Fabric data agent. Users also need the minimum permission on each underlying data source:
    ...
    For full details, see [Underlying data source permissions](https://learn.microsoft.com/en-us/fabric/data-science/data-agent-sharing#underlying-data-source-permissions).
...
-   For the REST sample, also set:
    ...
    -   Use user identity authentication. Service principal authentication isn't supported for the Fabric data agent.
    -   For more information about how agent identity works, see [Agent identity](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/agent-identity).

Note

-   For more information, see [Get ready to code](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code).
