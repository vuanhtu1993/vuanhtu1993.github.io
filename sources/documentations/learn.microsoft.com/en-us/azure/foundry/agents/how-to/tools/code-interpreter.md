---
title: "Use Code Interpreter with Microsoft Foundry agents - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/code-interpreter?tabs=prompt-agents&pivots=python"
crawled_at: "2026-06-27T11:33:09.729Z"
---
...
-   Basic or standard agent environment. See [agent environment setup](https://learn.microsoft.com/en-us/azure/foundry/agents/environment-setup) for details.
-   Latest SDK package installed for your language. The .NET SDK is currently in preview. See the [quickstart](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code) for installation steps.
...
You can customize Code Interpreter behavior at runtime, such as specifying which files to include or adjusting tool parameters per request, by using [structured inputs](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/structured-inputs).
...
For the current list of supported regions and models for Code Interpreter, see [Best practices for using tools in Microsoft Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice).
...
| Python package not available. | Code Interpreter has a fixed set of packages. | Code Interpreter includes common data science packages. For custom packages, use [Custom code interpreter](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/custom-code-interpreter). |
...
For examples of conversation and file cleanup patterns, see [Web search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/web-search) and [File search tool for agents](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/file-search).
...
-   **Session lifetime**: A Code Interpreter session is active for up to one hour, with an idle timeout (see the _Important_ note at the beginning of this article).
...
If you need more control over the sandbox runtime or you need a different isolation model, see [Custom code interpreter tool for agents](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/custom-code-interpreter).
...
-   [Custom code interpreter tool for agents (preview)](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/custom-code-interpreter)
