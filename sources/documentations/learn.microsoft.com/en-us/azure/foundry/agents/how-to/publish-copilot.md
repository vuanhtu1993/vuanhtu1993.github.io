---
title: "Publish agents to Microsoft 365 Copilot and Microsoft Teams - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/publish-copilot?source=recommendations"
crawled_at: "2026-06-27T11:30:07.105Z"
---
...
-   A [Foundry project](https://learn.microsoft.com/en-us/azure/foundry/how-to/create-projects) with an agent version you tested and want to publish
...
-   The following role assignments:
    ...
    -   For details, see [Role-based access control in the Foundry portal](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry).
...
For more information on selecting an active agent version and configuring other agent settings, see [Publish and share agents](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/configure-agent).

1.  In the Microsoft Foundry portal, select **Publish**.
    
    **Expected result**: A publish dropdown opens showing endpoint URLs, the active version, and a link to publish to Teams and Microsoft 365 Copilot. ![Expanded publish dropdown showing options](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782559806/aha-mind/docs-crawler/learn.microsoft.com/publish-dropdown_wpabwl.png)
    
2.  Select the arrow icon to the right of **Active version**.
    
    **Expected result**: A popup opens with options to always use the latest version or select a specific version. ![Screenshot of the active version popup showing Always use latest and specific version options.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782559806/aha-mind/docs-crawler/learn.microsoft.com/active-version_viyu4t.png)
    
3.  Select the active version you want to receive traffic from your agent's stable endpoint.
    
    **Expected result**: The publish dropdown closes and the **Publish** button displays a checkmark to indicate success. ::image type="content" source="../media/success-select-version.png" alt-text="Screenshot of the Publish button with a checkmark indicating the version was successfully selected.":::
...
5.  Choose how to publish. You can either [publish your agent directly from Foundry](#direct-publish) or [download and customize the agent manifest, then manually sideload it in Teams](#download-and-customize).
...
2.  Under **Choose who can use this agent**, select a scope:
    ...
    **People in your organization**:
    ...
    -   To check approval status, go to the [Microsoft 365 admin center](https://admin.cloud.microsoft/?#/agents/all/requested) and look for your agent under **Requests**.
        ...
        ![A screenshot of the Agent store in Microsoft 365 Copilot.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782559806/aha-mind/docs-crawler/learn.microsoft.com/agent-store_b0kvol.png)
...
| Publishing fails with identity error | The agent doesn't have a unique identity (`agent.identity` is null) | See the [migration guide](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/migrate-agent-applications) for steps to resolve this. |
...
[![Screenshot of how to share an Individual scoped published agent with others in your org.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782559806/aha-mind/docs-crawler/learn.microsoft.com/share-published-agent_qz7h6h.png)](https://learn.microsoft.com/en-us/azure/foundry/agents/media/agent-store.png#lightbox)
...
-   [Configure your agent endpoint and settings](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/configure-agent)
-   [Role-based access control in the Foundry portal](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry)
