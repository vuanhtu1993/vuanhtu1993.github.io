---
title: "Use web search tool in Foundry Agent Service - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/web-search?source=recommendations&tabs=prompt-agents&pivots=python"
crawled_at: "2026-06-27T11:33:00.794Z"
---
...
-   The latest SDK package. The .NET SDK is currently in preview. See the [quickstart](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code#install-and-authenticate) for details.
...
The following example shows how to give an agent access to web search. Select **Prompt Agents** to use the Azure AI Projects SDK to create a server-side prompt agent, or **Hosted Agents** to use the Agent Framework [`FoundryChatClient`](https://learn.microsoft.com/en-us/azure/foundry/agents/quickstarts/responses-api) to build an ephemeral, in-process agent.
...
The following example shows how to use the `o3-deep-research` model with the web search tool. This approach replaces the deprecated [Deep Research tool](https://learn.microsoft.com/en-us/azure/foundry-classic/agents/how-to/tools-classic/deep-research), enabling multi-step research using public web data directly through the web search tool.
...
For information about web search behavior and limitations in the Responses API, see [Web search with the Responses API](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/web-search).
...
| Tool not available for deployment | Regional or model limitations | Confirm web search is available in your region and with your model deployment. Check [tool best practices](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice). |
