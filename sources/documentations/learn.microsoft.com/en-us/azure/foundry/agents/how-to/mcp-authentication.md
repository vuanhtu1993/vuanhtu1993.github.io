---
title: "Set Up MCP Server Authentication - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/mcp-authentication"
crawled_at: "2026-06-27T11:27:16.217Z"
---
...
-   Access to the [Foundry portal](https://ai.azure.com/?cid=learnDocs) and a project. If you don't have one, see [Create projects in Foundry](https://learn.microsoft.com/en-us/azure/foundry/how-to/create-projects).
-   Permissions to create project connections and configure agents. For details, see [Role-based access control in the Foundry portal](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry).
...
For [private MCP servers within a virtual network](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/virtual-networks), Microsoft Entra authentication is a natural fit because both the agent and MCP server are on the same private network.
...
-   When a user first tries to use a new tool in a Foundry project, the response output shares the consent link in `response.output_item`. You can find the consent link in item type `oauth_consent_request`, under `consent_link`. Surface this consent link to the user.
    ...
    See an example: [![Screenshot that shows the consent dialog in the Foundry portal.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782559635/aha-mind/docs-crawler/learn.microsoft.com/foundry-open-consent_zuv7ck.png)](https://learn.microsoft.com/en-us/azure/foundry/media/mcp/foundry-open-consent.png#lightbox)
    
-   The user is prompted to sign in and give consent after reviewing the access needed. After giving consent successfully, the user sees a dialog like this example: [![Screenshot that shows the confirmation dialog after giving OAuth consent in the Foundry portal.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782559635/aha-mind/docs-crawler/learn.microsoft.com/foundry-close-me_rzhh9i.png)](https://learn.microsoft.com/en-us/azure/foundry/media/mcp/foundry-close-me.png#lightbox)
...
| **Authentication** | Custom authentication implementation required. | Use [built-in authentication](https://learn.microsoft.com/en-us/azure/app-service/configure-authentication-mcp?toc=%2Fazure%2Fazure-functions%2Ftoc.json) or custom code.
Azure Functions requires a key by default, but you can [disable the key requirement in host.json](https://learn.microsoft.com/en-us/azure/azure-functions/functions-bindings-mcp#hostjson-settings).
...
-   [Agent identity concepts in Foundry](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/agent-identity)
-   [Role-based access control in the Foundry portal](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry)
-   [Add a connection in Foundry](https://learn.microsoft.com/en-us/azure/foundry/how-to/connections-add)
