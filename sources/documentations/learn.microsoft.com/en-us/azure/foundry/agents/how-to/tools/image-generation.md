---
title: "Use the image generation tool (preview) in Foundry Agent Service - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/image-generation?tabs=prompt-agents&pivots=python"
crawled_at: "2026-06-27T11:34:16.652Z"
---

Important

-   The image generation tool requires the `gpt-image-1` model. See the [Azure OpenAI transparency note](https://learn.microsoft.com/en-us/azure/foundry/responsible-ai/openai/transparency-note?tabs=image) for limitations and responsible AI considerations.
...
-   A Foundry project.
-   A basic or standard agent environment. See [agent environment setup](https://learn.microsoft.com/en-us/azure/foundry/agents/environment-setup).
...
3.  Confirm your region and model support for image generation. See [Best practices for using tools in Microsoft Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice).

Before you start, install the latest SDK package. The .NET SDK is currently in preview. For package installation instructions, see the [quickstart](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code).

This sample creates an agent with the image generation tool, generates an image, and saves it to a file. Select **Prompt Agents** to use the Azure AI Projects SDK to create a server-side prompt agent, or **Hosted Agents** to use the Agent Framework [`FoundryChatClient`](https://learn.microsoft.com/en-us/azure/foundry/agents/quickstarts/responses-api) to build an ephemeral, in-process agent.
...
Content filtering can block image generation if the service detects unsafe content in your prompt. For more information, see [Guardrails and controls overview](https://learn.microsoft.com/en-us/azure/foundry/guardrails/guardrails-overview).
...
| Prompt doesn't produce an image | Content filtering blocked the request | Check content filtering logs. See [Guardrails and controls overview](https://learn.microsoft.com/en-us/azure/foundry/guardrails/guardrails-overview) for guidelines on acceptable prompts. |
| Tool not available | Regional or model limitation | Confirm the image generation tool is available in your region and with your orchestrator model. See [Best practices for using tools](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice). |
...
-   [Image generation in Azure OpenAI](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/dall-e)
-   [Responses API in Azure OpenAI](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/responses)
