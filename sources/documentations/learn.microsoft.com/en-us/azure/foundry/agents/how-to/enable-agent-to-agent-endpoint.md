---
title: "Enable incoming A2A on a Foundry agent - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/enable-agent-to-agent-endpoint?tabs=portal%2Cverify-bash%2Cconnection-bash"
crawled_at: "2026-06-27T11:31:13.463Z"
---
...
-   [REST API (Bash)](#tabpanel_1_rest-bash)
-   [REST API (PowerShell)](#tabpanel_1_rest-powershell)
...
-   [Bash](#tabpanel_2_verify-bash)
-   [PowerShell](#tabpanel_2_verify-powershell)
...
To grant a calling identity access, assign the **Foundry User** role on the Foundry project that hosts your agent. For more information about role assignments, see [Role-based access control in the Foundry portal](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry).
...
-   [REST API (Bash)](#tabpanel_3_connection-bash)
-   [REST API (PowerShell)](#tabpanel_3_connection-powershell)
...
For other authentication options (key-based, OAuth, managed identity), see [Create an A2A connection by using the REST API](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/agent-to-agent#create-an-a2a-connection-by-using-the-rest-api).
...
For more language examples (C#, JavaScript, Java, REST), see [Connect to an A2A agent endpoint from Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/agent-to-agent).
