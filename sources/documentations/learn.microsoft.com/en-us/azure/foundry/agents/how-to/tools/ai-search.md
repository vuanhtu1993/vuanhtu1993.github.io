---
title: "Connect an Azure AI Search index to Foundry agents - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/ai-search?tabs=prompt-agents%2Ckeys%2Cportal&pivots=python"
crawled_at: "2026-06-27T11:34:05.698Z"
---

Ground your Foundry agent's responses in your proprietary content by connecting it to an Azure AI Search index. The [Azure AI Search](https://learn.microsoft.com/en-us/azure/search/search-what-is-azure-search) tool retrieves indexed documents so the Foundry model powering the agent can generate answers with inline citations, enabling accurate, source-backed responses.
...
_Estimated setup time: 15-30 minutes if you have an existing search index_

-   A [basic or standard agent environment](https://learn.microsoft.com/en-us/azure/foundry/agents/environment-setup).
-   Install the SDK package for your preferred language. See the [quickstart](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code) for details.
...
-   An [Azure AI Search index configured for vector search](https://learn.microsoft.com/en-us/azure/search/search-get-started-portal-import-vectors) with:
...
-   You need the latest SDK package. For more information, see the [quickstart](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code).
...
Select **Prompt Agents** to use the Azure AI Projects SDK to create a server-side prompt agent, or **Hosted Agents** to use the Agent Framework [`FoundryChatClient`](https://learn.microsoft.com/en-us/azure/foundry/agents/quickstarts/responses-api) to build an ephemeral, in-process agent.
...
-   [Key-based authentication](#tabpanel_2_keys)
-   [Keyless authentication](#tabpanel_2_keyless)
...
2.  To get the endpoint:
    ...
    2.  Make a note of the URL, which should look like `https://my-service.search.windows.net`.
        ...
        [![A screenshot of an AI Search resource Overview tab in the Azure portal.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782560045/aha-mind/docs-crawler/learn.microsoft.com/connection-endpoint_wjjbrz.png)](https://learn.microsoft.com/en-us/azure/foundry/agents/media/tools/ai-search/connection-endpoint.png#lightbox)
...
3.  To get the API key:
    ...
    [![A screenshot of an AI Search resource Keys tab in the Azure portal.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782560045/aha-mind/docs-crawler/learn.microsoft.com/azure-portal_cbwlbk.png)](https://learn.microsoft.com/en-us/azure/foundry/agents/media/tools/ai-search/azure-portal.png#lightbox)
...
-   [Python SDK](#tabpanel_3_pythonsdk)
-   [REST API](#tabpanel_3_restapi)
...
For more detailed steps, see [Add a new connection to your project](https://learn.microsoft.com/en-us/azure/foundry/how-to/connections-add).
...
| Tool can't access the index (401/403) | Missing RBAC roles (keyless auth) | Assign the **Search Index Data Contributor** and **Search Service Contributor** roles to the Foundry project's managed identity. See [Azure RBAC in Foundry](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry). |
...
-   [Project Connections REST API reference](https://learn.microsoft.com/en-us/rest/api/microsoftfoundry/accountmanagement/project-connections?view=rest-microsoftfoundry-accountmanagement-2025-06-01&preserve-view=true)
...
-   [Create a vector search index in Azure AI Search](https://learn.microsoft.com/en-us/azure/search/search-get-started-portal-import-vectors)
-   [Quickstart: Build an agent with Foundry](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code)
