---
title: "Configure a custom code interpreter for agents - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/custom-code-interpreter?pivots=python"
crawled_at: "2026-06-27T11:33:57.535Z"
---
...
Use a custom code interpreter when the built-in [Code Interpreter tool for agents](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/code-interpreter) doesn't meet your requirements—for example, when you need specific Python packages, custom container images, or dedicated compute resources.

For more information about MCP and how agents connect to MCP tools, see [Connect to Model Context Protocol servers (preview)](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/model-context-protocol).
...
For the latest SDK and API support for agents tools, see [Best practices for using tools in Microsoft Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice).
...
-   An Azure subscription and resource group with the following role assignments:
    -   [Foundry Owner](https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles/ai-machine-learning#azure-ai-owner)
...
-   An Azure AI Foundry SDK. See the [quickstart](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code) for installation.
...
3.  In Microsoft Foundry, verify your agent calls the tool using tracing. For more information, see [Best practices for using tools in Microsoft Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice).
...
-   [Connect to Model Context Protocol servers (preview)](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/model-context-protocol)
...
-   [Code Interpreter tool for agents](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/code-interpreter)
