---
title: "Use your own resources in the Foundry Agent Service - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/use-your-own-resources"
crawled_at: "2026-06-27T11:25:31.090Z"
---
...
-   Use the connection string for your project located under **Connection string** in the overview of your project.
    ...
    ![A screenshot showing the legacy connection string for a hub-based project.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782559530/aha-mind/docs-crawler/learn.microsoft.com/connection-string_qvfgop.png)
...
-   An Azure subscription - [Create one for free](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn_5fb81aaf-033c-456e-8a7b-f3cf0521df38).
    
-   [Azure CLI](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli) (version 2.64 or later).
...
To use the [Grounding with Bing Search tool](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/bing-tools) the following provider must be registered: `Microsoft.Bing`
...
-   Learn about the different [tools](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-catalog) agents can use.
