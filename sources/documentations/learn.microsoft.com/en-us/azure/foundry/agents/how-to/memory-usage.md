---
title: "Create and Use Memory - Microsoft Foundry"
source_url: "https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/memory-usage?pivots=python"
crawled_at: "2026-06-27T11:31:31.121Z"
---
...
This article explains how to create, manage, and use memory stores. For conceptual information, see [Memory in Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/what-is-memory).
...
-   An Azure subscription. [Create one for free](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn_232d14dd-cb9c-8ff9-2455-101ec5e67288).
-   A [Microsoft Foundry project](https://learn.microsoft.com/en-us/azure/foundry/how-to/create-projects) with configured [authorization and permissions](#authorization-and-permissions).
-   A [chat model deployment](https://learn.microsoft.com/en-us/azure/foundry/foundry-models/how-to/create-model-deployments), such as `gpt-5.2`, in your project.
-   An [embedding model deployment](https://learn.microsoft.com/en-us/azure/foundry/openai/tutorials/embeddings), such as `text-embedding-3-small`, in your project.
-   A [configured local environment](#set-up-your-environment) with required packages and environment variables.

We recommend [role-based access control](https://learn.microsoft.com/en-us/azure/foundry/concepts/rbac-foundry) for production deployments. If roles aren't feasible, skip this section and use key-based authentication instead.
...
For more information about user profile and chat summary memories, see [Memory types](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/what-is-memory#memory-types).
...
-   [Memory store REST API reference](https://learn.microsoft.com/en-us/azure/foundry/reference/foundry-project-rest-preview)
-   [Memory in Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/what-is-memory)
-   [Foundry Agent Service quotas and limits](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/limits-quotas-regions)
-   [Build an agent with Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/quickstarts/get-started-code)
