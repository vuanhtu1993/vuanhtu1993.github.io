---
title: "Using the Fetch API with Undici in Node.js | Node.js Learn"
source_url: "https://nodejs.org/learn/getting-started/fetch"
crawled_at: "2026-07-20T08:07:23.393Z"
---
...
## [Basic GET Usage](#basic-get-usage)
...
## [Basic POST Usage](#basic-post-usage)
...
## [Customizing the Fetch API with Undici](#customizing-the-fetch-api-with-undici)
...
The [fetch](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) function takes two arguments: the URL to fetch and an options object. The options object is an [options object](https://undici.nodejs.org/#/docs/api/Dispatcher?id=parameter-requestoptions) that you can use to customize the request. The function returns a [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Using_promises) that resolves to a [Response](https://undici.nodejs.org/#/docs/api/Dispatcher?id=parameter-responsedata) object.
...
## [Streaming Responses with Undici](#streaming-responses-with-undici)
