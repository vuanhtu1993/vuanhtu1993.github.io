---
title: "Debugging Node.js | Node.js Learn"
source_url: "https://nodejs.org/learn/getting-started/debugging"
crawled_at: "2026-07-20T08:07:21.281Z"
---
...
### [Exposing the debug port publicly is unsafe](#exposing-the-debug-port-publicly-is-unsafe)
...
### [Local applications have full access to the inspector](#local-applications-have-full-access-to-the-inspector)
...
### [Browsers, WebSockets and same-origin policy](#browsers-websockets-and-same-origin-policy)
...
#### [Option 1: Use the built-in DevTools UI](#option-1-use-the-built-in-devtools-ui)
...
#### [Option 2: Connect manually](#option-2-connect-manually)
...
See [https://code.visualstudio.com/docs/nodejs/nodejs-debugging](https://code.visualstudio.com/docs/nodejs/nodejs-debugging) for more information.
...
### [JetBrains WebStorm and other JetBrains IDEs](#jetbrains-webstorm-and-other-jetbrains-ides)
...
### [Eclipse IDE with Eclipse Wild Web Developer extension](#eclipse-ide-with-eclipse-wild-web-developer-extension)
...
See [https://eclipseide.org/](https://eclipseide.org/) for more information.
...
## [Enabling remote debugging scenarios](#enabling-remote-debugging-scenarios)
...
## [Legacy Debugger](#legacy-debugger)
