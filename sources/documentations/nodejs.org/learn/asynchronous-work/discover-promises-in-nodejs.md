---
title: "Discover Promises in Node.js | Node.js Learn"
source_url: "https://nodejs.org/learn/asynchronous-work/discover-promises-in-nodejs"
crawled_at: "2026-07-20T08:09:30.349Z"
---
...
## [Basic Syntax of a Promise](#basic-syntax-of-a-promise)
...
## [Handling Promises with `.then()`, `.catch()`, and `.finally()`](#handling-promises-with-then-catch-and-finally)
...
## [Using Async/Await with Promises](#using-asyncawait-with-promises)
...
## [Promise-based Node.js APIs](#promise-based-nodejs-apis)
...
### [`Promise.reject()` and `Promise.resolve()`](#promisereject-and-promiseresolve)
...
## [Scheduling Tasks in the Event Loop](#scheduling-tasks-in-the-event-loop)
...
`setImmediate()` schedules a callback to be executed in the check phase of the Node.js [event loop](https://nodejs.org/learn/asynchronous-work/event-loop-timers-and-nexttick), which runs after the poll phase, where most I/O callbacks are processed.
...
For more information on the Event Loop, and the execution order of various phases, please see the related article, [The Node.js Event Loop](https://nodejs.org/learn/asynchronous-work/event-loop-timers-and-nexttick).
