...
source_url: "https://docs.langchain.com/oss/javascript/deepagents/streaming"
crawled_at: "2026-06-17T14:45:52.812Z"
---
...
-   [Subagents](https://docs.langchain.com/oss/javascript/deepagents/subagents)—Configure and use subagents with Deep Agents
-   [Frontend streaming](https://docs.langchain.com/oss/javascript/deepagents/frontend/overview)—Build React UIs with [`useStream`](https://reference.langchain.com/javascript/langchain-react/index/useStream) for Deep Agents
-   [LangChain Event Streaming](https://docs.langchain.com/oss/javascript/langchain/event-streaming)—General streaming concepts with LangChain agents
