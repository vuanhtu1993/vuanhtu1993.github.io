---
title: "Agent Client Protocol (ACP) - Docs by LangChain"
source_url: "https://docs.langchain.com/oss/javascript/deepagents/acp"
crawled_at: "2026-06-17T14:46:05.511Z"
---

[Agent Client Protocol (ACP)](https://agentclientprotocol.com/get-started/introduction) standardizes communication between coding agents and code editors or IDEs. With the ACP protocol, you can make use of your custom deep agents with any ACP-compatible client, allowing your code editor to provide project context and receive rich updates.
...
Register your deep agent with [Zed](https://zed.dev/docs/ai/external-agents) by adding it to your Zed settings (`~/.config/zed/settings.json` on Linux, `~/Library/Application Support/Zed/settings.json` on macOS): **Simple setup (no code required):**
...
| `middleware` | `AgentMiddleware[]` | Custom middleware appended to the [default stack](https://docs.langchain.com/oss/javascript/deepagents/customization#default-stack-main-agent) |
