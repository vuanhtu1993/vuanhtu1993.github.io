...
| --- | --- | --- | --- | --- |
| [`RedisVectorStore`](https://reference.langchain.com/javascript/langchain-redis/RedisVectorStore) | [`@langchain/redis`](https://www.npmjs.com/package/@langchain/redis) | ✅ | ![NPM - Downloads](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781707930/aha-mind/docs-crawler/docs.langchain.com/redis_hmqjhj.svg) | ![NPM - Version](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781707930/aha-mind/docs-crawler/docs.langchain.com/redis_uexdgm.svg) |

## Setup

To use Redis vector stores, set up a Redis Stack instance with RediSearch enabled and install `@langchain/redis` and `@langchain/core`. Install the [`redis`](https://www.npmjs.com/package/redis) Node.js client when you pass your own `createClient` instance to `RedisVectorStore`. This guide uses [OpenAI embeddings](https://docs.langchain.com/oss/javascript/integrations/embeddings/openai) as an example. You can use [other supported embeddings models](https://docs.langchain.com/oss/javascript/integrations/embeddings) instead.
