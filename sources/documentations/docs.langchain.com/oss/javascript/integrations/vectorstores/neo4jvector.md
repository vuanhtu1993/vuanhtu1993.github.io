---
title: "Neo4j vector index integration - Docs by LangChain"
source_url: "https://docs.langchain.com/oss/javascript/integrations/vectorstores/neo4jvector"
crawled_at: "2026-06-17T14:50:59.157Z"
---

[Neo4j](https://neo4j.com/) is an open-source graph database with integrated support for vector similarity search. It supports approximate nearest neighbor search, Euclidean and cosine similarity, and hybrid search that combines vector and keyword retrieval. This guide helps you get started with the Neo4j [vector store](https://docs.langchain.com/oss/javascript/integrations/vectorstores). For detailed documentation of all `Neo4jVectorStore` features and configurations, see the [API reference](https://reference.langchain.com/javascript/langchain-neo4j/Neo4jVectorStore).
...
| --- | --- | --- | --- | --- |
| [`Neo4jVectorStore`](https://reference.langchain.com/javascript/langchain-neo4j/Neo4jVectorStore) | [`@langchain/neo4j`](https://www.npmjs.com/package/@langchain/neo4j) | ✅ | ![NPM - Downloads](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781707860/aha-mind/docs-crawler/docs.langchain.com/neo4j_qs46yu.svg) | ![NPM - Version](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781707860/aha-mind/docs-crawler/docs.langchain.com/neo4j_j69fav.svg) |

## Setup

Install `@langchain/neo4j`, the MongoDB-compatible `neo4j-driver`, `@langchain/core`, and an embeddings provider (this guide uses [OpenAI embeddings](https://docs.langchain.com/oss/javascript/integrations/embeddings/openai)):
...
And then in the same directory, run `docker compose up` to start the container. You can find more information on how to setup `Neo4j` on their [website](https://neo4j.com/docs/operations-manual/current/installation/).
...
-   Vector store [conceptual guide](https://docs.langchain.com/oss/javascript/integrations/vectorstores)
-   Vector store [how-to guides](https://docs.langchain.com/oss/javascript/integrations/vectorstores)
