---
title: "ChatAnthropic integration - Docs by LangChain"
source_url: "https://docs.langchain.com/oss/javascript/integrations/chat/anthropic"
crawled_at: "2026-06-17T14:55:44.341Z"
---

[Anthropic](https://www.anthropic.com/) is an AI safety and research company. They are the creator of Claude. This will help you getting started with `ChatAnthropic` [chat models](https://docs.langchain.com/oss/javascript/langchain/models). For detailed documentation of all `ChatAnthropic` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropic).
...
| --- | --- | --- | --- | --- | --- |
| [`ChatAnthropic`](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropic) | [`@langchain/anthropic`](https://www.npmjs.com/package/@langchain/anthropic) | ✅ | ✅ | ![NPM - Downloads](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781708145/aha-mind/docs-crawler/docs.langchain.com/anthropic_enkwym.svg) | ![NPM - Version](https://res.cloudinary.com/dv3vzmogk/image/upload/v1781708145/aha-mind/docs-crawler/docs.langchain.com/anthropic_gopcjg.svg) |
...
Learn more about [how RAG works in LangChain](https://js.langchain.com/docs/concepts/rag/) [Learn more about tool calling](https://docs.langchain.com/oss/javascript/langchain/tools)
...
Anthropic supports a context editing feature that will automatically manage the model’s context window (e.g., by clearing tool results). See [Anthropic documentation](https://platform.claude.com/docs/en/build-with-claude/context-editing) for details and configuration options.
...
For detailed documentation of all `ChatAnthropic` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-anthropic/ChatAnthropic).
