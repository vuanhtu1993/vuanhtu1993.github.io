---
title: "Tavily integrations - Docs by LangChain"
source_url: "https://docs.langchain.com/oss/javascript/integrations/providers/tavily"
crawled_at: "2026-06-17T14:52:15.178Z"
---
...
A search tool that returns real-time, LLM-ready results from Tavily’s Search API. See a [usage example](https://docs.langchain.com/oss/javascript/integrations/tools/tavily_search).

```
import { TavilySearch } from "@langchain/tavily";
```

A tool that returns the cleaned, parsed content of one or more URLs. See a [usage example](https://docs.langchain.com/oss/javascript/integrations/tools/tavily_extract).
...
A tool that performs a structured web traversal from a base URL, with optional natural-language instructions and path/domain filters. See a [usage example](https://docs.langchain.com/oss/javascript/integrations/tools/tavily_crawl).
...
A tool that discovers the URL structure of a site without extracting page content. See a [usage example](https://docs.langchain.com/oss/javascript/integrations/tools/tavily_map).
