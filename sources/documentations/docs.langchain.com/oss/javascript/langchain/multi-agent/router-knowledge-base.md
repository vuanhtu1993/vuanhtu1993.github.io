...
source_url: "https://docs.langchain.com/oss/javascript/langchain/multi-agent/router-knowledge-base"
crawled_at: "2026-06-17T14:53:50.842Z"
---
...
-   [StateGraph](https://docs.langchain.com/oss/javascript/langgraph/graph-api) for workflow orchestration
-   [Send API](https://docs.langchain.com/oss/javascript/langgraph/graph-api#send) for parallel execution
...
If you need the router itself to maintain state—for example, to use previous search results in routing decisions—use [persistence](https://docs.langchain.com/oss/javascript/langchain/short-term-memory) to store message history at the router level.
...
-   Learn about [handoffs](https://docs.langchain.com/oss/javascript/langchain/multi-agent/handoffs) for agent-to-agent conversations
-   Explore the [subagents pattern](https://docs.langchain.com/oss/javascript/langchain/multi-agent/subagents-personal-assistant) for centralized orchestration
-   Read the [multi-agent overview](https://docs.langchain.com/oss/javascript/langchain/multi-agent) to compare different patterns
