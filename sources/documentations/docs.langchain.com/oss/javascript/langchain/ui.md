...
source_url: "https://docs.langchain.com/oss/javascript/langchain/ui"
crawled_at: "2026-06-17T14:48:39.967Z"
---
...
Agent Chat UI can connect to both [local](https://docs.langchain.com/oss/javascript/langchain/studio) and [deployed agents](https://docs.langchain.com/oss/javascript/langchain/deploy). After starting Agent Chat UI, you’ll need to configure it to connect to your agent:
