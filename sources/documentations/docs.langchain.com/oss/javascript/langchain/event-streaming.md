...
source_url: "https://docs.langchain.com/oss/javascript/langchain/event-streaming"
crawled_at: "2026-06-17T14:47:32.472Z"
---
...
See the [reasoning guide](https://docs.langchain.com/oss/javascript/langchain/models#reasoning) and your provider’s integration page for model configuration details.
...
This keeps the built-in tool-call projection in front of consumer transformers and gives caller-supplied entries the final word. See [Build your own projection](https://docs.langchain.com/oss/javascript/langgraph/event-streaming#build-your-own-projection) for the transformer contract.

-   [Streaming](https://docs.langchain.com/oss/javascript/langchain/streaming) covers low-level Pregel stream modes.
-   [Build your own projection](https://docs.langchain.com/oss/javascript/langgraph/event-streaming#build-your-own-projection) covers writing application-specific projections.
-   [Frontend streaming patterns](https://docs.langchain.com/oss/javascript/langchain/frontend/overview) shows UI use cases built on streamed state.
