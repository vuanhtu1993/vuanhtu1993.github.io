...
crawled_at: "2026-06-17T14:42:19.725Z"
---
...
Use the `messages` streaming mode to stream Large Language Model (LLM) outputs **token by token** from any part of your graph, including nodes, tools, subgraphs, or tasks. The streamed output from [`messages` mode](#stream-modes) is a tuple `[message_chunk, metadata]` where:
