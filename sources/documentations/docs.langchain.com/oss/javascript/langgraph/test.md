...
2.  Call your agent’s [`update_state`](https://docs.langchain.com/oss/javascript/langgraph/use-time-travel) method with an [`asNode`](https://docs.langchain.com/oss/javascript/langgraph/use-time-travel#from-a-specific-node) parameter set to the name of the node _before_ the one you want to start your test.
