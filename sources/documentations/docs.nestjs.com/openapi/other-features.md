...
source_url: "https://docs.nestjs.com/openapi/other-features"
crawled_at: "2026-06-23T15:24:10.115Z"
---
...
#### Global prefix[#](https://docs.nestjs.com/openapi/other-features#global-prefix)
...
#### Global parameters[#](https://docs.nestjs.com/openapi/other-features#global-parameters)
...
#### Global responses[#](https://docs.nestjs.com/openapi/other-features#global-responses)
...
#### Multiple specifications[#](https://docs.nestjs.com/openapi/other-features#multiple-specifications)
...
![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782228249/aha-mind/docs-crawler/docs.nestjs.com/swagger-cats_it1v5p.png)

In turn, `http://localhost:3000/api/dogs` will expose the Swagger UI for dogs:

![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782228249/aha-mind/docs-crawler/docs.nestjs.com/swagger-dogs_z2oogu.png)

#### Dropdown in the explorer bar[#](https://docs.nestjs.com/openapi/other-features#dropdown-in-the-explorer-bar)
...
> **Hint** Ensure that `swaggerOptions.urls` points to the JSON format of your Swagger documents! To specify the JSON document, use `jsonDocumentUrl` within `SwaggerCustomOptions`. For more setup options, check [here](https://docs.nestjs.com/openapi/introduction#setup-options).
