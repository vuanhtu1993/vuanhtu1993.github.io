...
source_url: "https://docs.nestjs.com/recipes/hot-reload"
crawled_at: "2026-06-23T15:24:24.838Z"
---

-   [Hot Reload](https://docs.nestjs.com/recipes/hot-reload#hot-reload)
-   [With CLI](https://docs.nestjs.com/recipes/hot-reload#with-cli)
-   [Installation](https://docs.nestjs.com/recipes/hot-reload#installation)
-   [Configuration](https://docs.nestjs.com/recipes/hot-reload#configuration)
-   [Hot-Module Replacement](https://docs.nestjs.com/recipes/hot-reload#hot-module-replacement)
-   [Without CLI](https://docs.nestjs.com/recipes/hot-reload#without-cli)
-   [Installation](https://docs.nestjs.com/recipes/hot-reload#installation-1)
-   [Configuration](https://docs.nestjs.com/recipes/hot-reload#configuration-1)
-   [Hot-Module Replacement](https://docs.nestjs.com/recipes/hot-reload#hot-module-replacement-1)
-   [Example](https://docs.nestjs.com/recipes/hot-reload#example)
...
> **Hint** With **Yarn Berry** (not classic Yarn), instead of using the `nodeExternals` in the `externals` configuration property, use the `WebpackPnpExternals` from `webpack-pnp-externals` package: `WebpackPnpExternals({ exclude: ['webpack/hot/poll?100'] })`.
