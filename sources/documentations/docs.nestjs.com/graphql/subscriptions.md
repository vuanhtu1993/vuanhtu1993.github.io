...
source_url: "https://docs.nestjs.com/graphql/subscriptions"
crawled_at: "2026-06-23T15:21:52.175Z"
---
...
In the examples above, we used the default `PubSub` emitter ([mqemitter](https://github.com/mcollina/mqemitter)) The preferred approach (for production) is to use `mqemitter-redis`. Alternatively, a custom `PubSub` implementation can be provided (read more [here](https://github.com/mercurius-js/mercurius/blob/master/docs/subscriptions.md))
