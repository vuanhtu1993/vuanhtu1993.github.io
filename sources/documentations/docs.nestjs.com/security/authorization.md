...
crawled_at: "2026-06-23T15:21:24.822Z"
---
...
> **Hint** The `detectSubjectType` option lets CASL understand how to get the subject type out of an object. For more information, read the [CASL documentation](https://casl.js.org/v6/en/guide/subject-type-detection#use-classes-as-subject-types).
