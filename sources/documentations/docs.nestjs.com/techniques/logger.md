...
crawled_at: "2026-06-23T15:20:48.043Z"
---
...
> **Hint** Log levels in Nest are cascading (inherited). This means that providing a specific log level (like `'log'`) will automatically include all higher-severity levels (e.g., `'warn'`, `'error'`, and `'fatal'`).
