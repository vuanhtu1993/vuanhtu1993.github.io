...
crawled_at: "2026-06-23T15:21:06.177Z"
---

-   [HTTP module](https://docs.nestjs.com/techniques/http-module#http-module)
-   [Installation](https://docs.nestjs.com/techniques/http-module#installation)
-   [Getting started](https://docs.nestjs.com/techniques/http-module#getting-started)
-   [Configuration](https://docs.nestjs.com/techniques/http-module#configuration)
-   [Async configuration](https://docs.nestjs.com/techniques/http-module#async-configuration)
-   [Using Axios directly](https://docs.nestjs.com/techniques/http-module#using-axios-directly)
-   [Full example](https://docs.nestjs.com/techniques/http-module#full-example)
...
> **Hint** You can also use any general purpose Node.js HTTP client library directly, including [got](https://github.com/sindresorhus/got) or [undici](https://github.com/nodejs/undici).
...
> **Hint**`HttpModule` and `HttpService` are imported from `@nestjs/axios` package.
...
> **Hint**`AxiosResponse` is an interface exported from the `axios` package (`$ npm i axios`).
...
> **Hint** Visit RxJS's documentation on [`firstValueFrom`](https://rxjs.dev/api/index/function/firstValueFrom) and [`lastValueFrom`](https://rxjs.dev/api/index/function/lastValueFrom) for differences between them.
