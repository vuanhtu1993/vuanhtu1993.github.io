---
title: "Documentation - TypeScript 4.4"
source_url: "https://www.typescriptlang.org/docs/handbook/release-notes/typescript-4-4.html"
crawled_at: "2026-07-02T07:40:34.479Z"
---
...
![The new TypeScript --help menu where the output is bucketed into several different areas](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782978035/aha-mind/docs-crawler/www.typescriptlang.org/tsc-help-ps-wt-4-4_l100zm.png)
...
![A preview of inlay hints in Visual Studio Code](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782978035/aha-mind/docs-crawler/www.typescriptlang.org/inlayHints-4.4-rc-ghd_i6hd6u.png)
...
![A completion list containing unwieldy paths containing 'node\_modules'. For example, the label for 'calendarFormat' is 'node\_modules/moment/moment' instead of 'moment'.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782978035/aha-mind/docs-crawler/www.typescriptlang.org/completion-import-labels-pre-4-4_fvocul.png)
...
![A completion list containing clean paths with no intermediate 'node\_modules'. For example, the label for 'calendarFormat' is 'moment' instead of 'node\_modules/moment/moment'.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782978035/aha-mind/docs-crawler/www.typescriptlang.org/completion-import-labels-4-4_cta4gb.png)
