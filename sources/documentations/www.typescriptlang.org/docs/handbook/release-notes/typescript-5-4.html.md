...
![A quick fix being offered when someFunction calls someHelperFunction with 2 more arguments than are expected.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782977979/aha-mind/docs-crawler/www.typescriptlang.org/add-missing-params-5-4-beta-before_xnkzcg.png)

![The missing arguments have been added to someHelperFunction after the quick fix was applied.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1782977979/aha-mind/docs-crawler/www.typescriptlang.org/add-missing-params-5-4-beta-after_p8qxzx.png)
