...
crawled_at: "2026-07-28T04:06:42.237Z"
---
...
### `resumeAndPrerender(reactNode, postponedState, options?)`[](#resumeandprerender "Link for this heading")
...
### When should I use `resumeAndPrerender`?[](#when-to-use-prerender "Link for this heading")
...
`resumeAndPrerender` behaves similarly to [`prerender`](https://react.dev/reference/react-dom/static/prerender) but can be used to continue a previously started prerendering process that was aborted. For more information about resuming a prerendered tree, see the [resume documentation](https://react.dev/reference/react-dom/server/resume#resuming-a-prerender).
