...
crawled_at: "2026-07-28T02:22:05.164Z"
---
...
![Diagram showing a tree of three components, one parent labeled MyApp and two children labeled MyButton. Both MyButton components contain a count with value zero.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_qmkmyk.png)

![Diagram showing a tree of three components, one parent labeled MyApp and two children labeled MyButton. Both MyButton components contain a count with value zero.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_cyfh4e.png)

Initially, each `MyButton`’s `count` state is `0`

![The same diagram as the previous, with the count of the first child MyButton component highlighted indicating a click with the count value incremented to one. The second MyButton component still contains value zero.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_c0qaw9.png)

![The same diagram as the previous, with the count of the first child MyButton component highlighted indicating a click with the count value incremented to one. The second MyButton component still contains value zero.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_pjnyic.png)
...
![Diagram showing a tree of three components, one parent labeled MyApp and two children labeled MyButton. MyApp contains a count value of zero which is passed down to both of the MyButton components, which also show value zero.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_lu7hle.png)

![Diagram showing a tree of three components, one parent labeled MyApp and two children labeled MyButton. MyApp contains a count value of zero which is passed down to both of the MyButton components, which also show value zero.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_pomfjj.png)

Initially, `MyApp`’s `count` state is `0` and is passed down to both children

![The same diagram as the previous, with the count of the parent MyApp component highlighted indicating a click with the value incremented to one. The flow to both of the children MyButton components is also highlighted, and the count value in each child is set to one indicating the value was passed down.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_qljxxc.png)

![The same diagram as the previous, with the count of the parent MyApp component highlighted indicating a click with the value incremented to one. The flow to both of the children MyButton components is also highlighted, and the count value in each child is set to one indicating the value was passed down.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205324/aha-mind/docs-crawler/react.dev/image_nryopq.png)
