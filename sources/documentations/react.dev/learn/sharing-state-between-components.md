...
crawled_at: "2026-07-28T02:25:48.349Z"
---
...
![Diagram showing a tree of three components, one parent labeled Accordion and two children labeled Panel. Both Panel components contain isActive with value false.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_o4w5td.png)

![Diagram showing a tree of three components, one parent labeled Accordion and two children labeled Panel. Both Panel components contain isActive with value false.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_sbpet6.png)

Initially, each `Panel`’s `isActive` state is `false`, so they both appear collapsed

![The same diagram as the previous, with the isActive of the first child Panel component highlighted indicating a click with the isActive value set to true. The second Panel component still contains value false.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_uyqdvx.png)

![The same diagram as the previous, with the isActive of the first child Panel component highlighted indicating a click with the isActive value set to true. The second Panel component still contains value false.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_ov9us4.png)
...
![Diagram showing a tree of three components, one parent labeled Accordion and two children labeled Panel. Accordion contains an activeIndex value of zero which turns into isActive value of true passed to the first Panel, and isActive value of false passed to the second Panel.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_oc5rge.png)

![Diagram showing a tree of three components, one parent labeled Accordion and two children labeled Panel. Accordion contains an activeIndex value of zero which turns into isActive value of true passed to the first Panel, and isActive value of false passed to the second Panel.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_f8ibag.png)

Initially, `Accordion`’s `activeIndex` is `0`, so the first `Panel` receives `isActive = true`

![The same diagram as the previous, with the activeIndex value of the parent Accordion component highlighted indicating a click with the value changed to one. The flow to both of the children Panel components is also highlighted, and the isActive value passed to each child is set to the opposite: false for the first Panel and true for the second one.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_cd8xsj.png)

![The same diagram as the previous, with the activeIndex value of the parent Accordion component highlighted indicating a click with the value changed to one. The flow to both of the children Panel components is also highlighted, and the isActive value passed to each child is set to the opposite: false for the first Panel and true for the second one.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205546/aha-mind/docs-crawler/react.dev/image_jbavwm.png)
