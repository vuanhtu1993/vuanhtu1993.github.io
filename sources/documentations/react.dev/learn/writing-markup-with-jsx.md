...
crawled_at: "2026-07-28T02:23:29.164Z"
---
...
![HTML markup with purple background and a div with two child tags: p and form. ](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_vmnvqv.png)

![HTML markup with purple background and a div with two child tags: p and form. ](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_sciwcw.png)

HTML

![Three JavaScript handlers with yellow background: onSubmit, onLogin, and onClick.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_xnlgfl.png)

![Three JavaScript handlers with yellow background: onSubmit, onLogin, and onClick.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_p9ab4r.png)

JavaScript

But as the Web became more interactive, logic increasingly determined content. JavaScript was in charge of the HTML! This is why **in React, rendering logic and markup live together in the same place—components.**

![React component with HTML and JavaScript from previous examples mixed. Function name is Sidebar which calls the function isLoggedIn, highlighted in yellow. Nested inside the function highlighted in purple is the p tag from before, and a Form tag referencing the component shown in the next diagram.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_aw7kct.png)

![React component with HTML and JavaScript from previous examples mixed. Function name is Sidebar which calls the function isLoggedIn, highlighted in yellow. Nested inside the function highlighted in purple is the p tag from before, and a Form tag referencing the component shown in the next diagram.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_k8nwjj.png)

`Sidebar.js` React component

![React component with HTML and JavaScript from previous examples mixed. Function name is Form containing two handlers onClick and onSubmit highlighted in yellow. Following the handlers is HTML highlighted in purple. The HTML contains a form element with a nested input element, each with an onClick prop.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_yhtkol.png)

![React component with HTML and JavaScript from previous examples mixed. Function name is Form containing two handlers onClick and onSubmit highlighted in yellow. Following the handlers is HTML highlighted in purple. The HTML contains a form element with a nested input element, each with an onClick prop.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205408/aha-mind/docs-crawler/react.dev/image_ybuhqo.png)
