...
crawled_at: "2026-07-28T02:24:57.004Z"
---
...
1.  ![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205495/aha-mind/docs-crawler/react.dev/i_render1_n6lbj1.png)
    
    React executing the function
    
2.  ![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205495/aha-mind/docs-crawler/react.dev/i_render2_hzem72.png)
    
    Calculating the snapshot
    
3.  ![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205495/aha-mind/docs-crawler/react.dev/i_render3_ptueri.png)
...
1.  ![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205495/aha-mind/docs-crawler/react.dev/i_state-snapshot1_wdryeb.png)
    
    You tell React to update the state
    
2.  ![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205495/aha-mind/docs-crawler/react.dev/i_state-snapshot2_mapm7q.png)
    
    React updates the state value
    
3.  ![](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205495/aha-mind/docs-crawler/react.dev/i_state-snapshot3_wl392m.png)
