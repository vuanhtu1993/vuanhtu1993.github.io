...
source_url: "https://react.dev/learn/reacting-to-input-with-state"
crawled_at: "2026-07-28T02:25:31.991Z"
---
...
![In a car driven by an anxious-looking person representing JavaScript, a passenger orders the driver to execute a sequence of complicated turn by turn navigations.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205531/aha-mind/docs-crawler/react.dev/i_imperative-ui-programming_udjdjx.png)
...
![In a car driven by React, a passenger asks to be taken to a specific place on the map. React figures out how to do that.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205531/aha-mind/docs-crawler/react.dev/i_declarative-ui-programming_fujxwx.png)
...
![A finger.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205531/aha-mind/docs-crawler/react.dev/i_inputs1_lrejwq.png)

Human inputs

![Ones and zeroes.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205531/aha-mind/docs-crawler/react.dev/i_inputs2_nbwq6k.png)
...
![Flow chart moving left to right with 5 nodes. The first node labeled 'empty' has one edge labeled 'start typing' connected to a node labeled 'typing'. That node has one edge labeled 'press submit' connected to a node labeled 'submitting', which has two edges. The left edge is labeled 'network error' connecting to a node labeled 'error'. The right edge is labeled 'network success' connecting to a node labeled 'success'.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205531/aha-mind/docs-crawler/react.dev/image_gujwdc.png)

![Flow chart moving left to right with 5 nodes. The first node labeled 'empty' has one edge labeled 'start typing' connected to a node labeled 'typing'. That node has one edge labeled 'press submit' connected to a node labeled 'submitting', which has two edges. The left edge is labeled 'network error' connecting to a node labeled 'error'. The right edge is labeled 'network success' connecting to a node labeled 'success'.](https://res.cloudinary.com/dv3vzmogk/image/upload/v1785205531/aha-mind/docs-crawler/react.dev/image_qqpmrj.png)
