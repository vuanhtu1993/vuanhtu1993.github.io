...
```mermaid
graph TD
    OL["☁️ OneLake\nStorage (50GB × $0.023/GB/mo)"] --> WS["🔵 Fabric Workspace"]
    WS --> DE["⚡ Data Engineering\nSpark Notebooks"]
    WS --> DF["🔀 Data Factory\nPipelines"]
    WS --> DW["🏭 Synapse Data Warehouse"]
    WS --> PBI["📊 Power BI\n(miễn phí trong gói)"]
...
```mermaid
graph LR
    S3["🪣 Amazon S3\nRaw/Staged/Serving\n50GB × $0.023/GB/mo"] --> GLUE["⚙️ AWS Glue\nETL Jobs\n$0.44/DPU-hr"]
    S3 --> EMR["⚡ EMR Serverless\nSpark Jobs\n$0.052/vCPU-hr"]
    GLUE --> ATHENA["🔍 Amazon Athena\nSQL Queries\n$5/TB scanned"]
    EMR --> ATHENA
    ATHENA --> BI["📊 Amazon QuickSight\nor 3rd-party BI"]
...
mindmap
  root(("☁️ Cloud Cost\nAnalytics Engineer"))
    ...
    AWS["AWS Native"]
      ...
      glue["Glue: ~$26/student (đắt hơn)"]
      s3["S3: $0.023/GB/mo"]
      best_for2["Best for: Market demand, Loosely coupled learning"]
    Databricks["Azure Databricks"]
      job["Job Compute: ~$19/student"]
      ap["All-Purpose: ~$25/student"]
      adls["ADLS Gen2: $0.019/GB"]
      best_for3["Best for: Enterprise Spark, Certification track"]
    Optimize["💡 FinOps Tips"]
      pause["Pause/Auto-terminate clusters"]
      spot["Spot Instances: -60-80%"]
      serverless["Prefer Serverless over Cluster"]
